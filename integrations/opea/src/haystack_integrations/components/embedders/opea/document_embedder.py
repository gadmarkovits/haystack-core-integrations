...
class OPEADocumentEmbedder:
    ...
    Usage example:
    ```python
    from haystack_integrations.components.embedders.opea import OPEADocumentEmbedder

    doc = Document(content="I love pizza!")

    text_embedder = OPEADocumentEmbedder(api_url="http://localhost:8090")
    ...
    def __init__(
        ...
        """
        Create a OPEADocumentEmbedder component.
